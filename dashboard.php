<?php 
session_start();
if($_SESSION['id'] == ''){header("Location: http://localhost/geniusparkle/Sign-In.php");};
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script>
var navCta = '<div id="nav-cta"><a data-btn="s" href="logout.php">Log Out</a></div>';
$("nav").append(navCta);
...
<section data-cntnr="md" data-pdg="xl-md">
  <h1 data-pdg="-sm"><span data-bg-anim="primary">Welcome <?php echo $_SESSION["name"]?></span></h1>
  
  <p data-pdg="-md" class="xl">
    Now You are in admin area. <br>
 
 </p>
 <p>
 Name: <b> <?php echo $_SESSION["name"]?></b><br>
 Email: <b> <?php echo $_SESSION["email"]?></b>
